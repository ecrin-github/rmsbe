...
public class DtpDatasetsApiController : BaseApiController
{
    ...
    ****************************************************************/
    ...
    [HttpGet("data-transfers/{sd_oid}/datasets/{id:int}")]
    ...
    ****************************************************************/
    ...
    [HttpPost("data-transfers/{sd_oid}/datasets")]
    [SwaggerOperation(Tags = new []{"Data transfer process datasets endpoint"})]
    ...
    ****************************************************************/
    ...
    [HttpPut("data-transfers/{sd_oid}/datasets/{id:int}")]
    [SwaggerOperation(Tags = new []{"Data transfer process datasets endpoint"})]
    ...
    ****************************************************************/
    ...
    [HttpDelete("data-transfers/{sd_oid}/datasets/{id:int}")]
    [SwaggerOperation(Tags = new []{"Data transfer process datasets endpoint"})]
